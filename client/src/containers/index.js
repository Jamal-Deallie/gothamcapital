...
export { default as ApartContainer } from './Apart';
export { default as RecordContainer } from './Record';
export { default as CTAContainer } from './CTA';
export {default as ValuesContainer} from './Values'
export {default as VisionContainer} from './Vision'
...
export {default as LeadersContainer} from "./Leaders"
...
export {default as StandardsContainer} from "./Standards"
export {default as AwardsContainer} from "./Awards"
